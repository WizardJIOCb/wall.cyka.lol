<?php
/**
 * Wall Social Platform - User Model (Debug Version)
 * 
...
class User
{
    ...
    public static function create($data)
    {
        ...
        // DEBUG OUTPUT
        error_log("DEBUG: User::create called with data: " . print_r($data, true));
        error_log("DEBUG: SQL = " . $sql);
        error_log("DEBUG: Params = " . print_r($params, true));
        error_log("DEBUG: Config bricks = " . print_r($config['bricks'], true));
        ...
        try {
            ...
            error_log("DEBUG: Exception in User::create: " . $e->getMessage());
